function [grad] = plotPointsWithLFit_new(mtable, extbl, ax, yl, p, scid, fromd, tod, exclwind, periodtype, meastype, bestwind, gradtype)
...
twindow = calmonths(between(fromd,tod,'months'));
